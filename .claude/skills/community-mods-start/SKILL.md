---
name: community-mods-start
description: Session-resume skill for the Curated and featured community mods repo (dormant stub). Auto-fires on the first user turn in this repo. Reads vault/context.md + vault/conventions.md, checks vault/decisions/ for recent entries, surfaces git status and GSD phase state, and prints a compact briefing.
argument-hint: ""
allowed-tools: Read, Bash, Grep, Glob
---

# /community-mods-start — Resume session
...
- **Manually** when the user types `/community-mods-start`.
...
```
## Resume briefing — Curated and featured community mods
